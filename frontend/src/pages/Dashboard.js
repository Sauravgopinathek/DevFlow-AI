...
const Dashboard = () => {
  ...
  const handleDeleteRepository = async () => {
    ...
    if (!window.confirm(`Are you sure you want to delete the repository "${repoToDelete}"? This action cannot be undone!`)) {
      return;
    }
    ...
    try {
      ...
      setMessage({ type: 'success', text: `Repository ${owner}/${repo} deleted successfully` });
      setRepoToDelete('');
      ...
      setMessage({ 
        type: 'error', 
        text: error.response?.data?.error || 'Failed to delete repository' 
      });
    } finally {
      setActionLoading(null);
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl font-bold text-black dark:text-white">Loading your dashboard</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex justify-end mb-6">
          <button
            ...
            className="bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <button 
            ...
            className="p-6 hover:shadow-lg transition-all duration-300 cursor-pointer disabled:opacity-50 rounded-2xl border bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700"
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-semibold text-gray-600 dark:text-gray-300">Repositories</p>
                <p className="text-3xl font-bold text-black dark:text-white">{stats.repositories}</p>
              </div>
              <div className="w-12 h-12 bg-gray-600 dark:bg-gray-400 rounded-lg flex items-center justify-center">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-semibold text-gray-600 dark:text-gray-300">Open Issues</p>
                <p className="text-3xl font-bold text-black dark:text-white">{stats.openIssues}</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-lg font-semibold text-gray-600 dark:text-gray-300">Pull Requests</p>
                <p className="text-3xl font-bold text-black dark:text-white">{stats.pullRequests}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 mb-16">
          ...
          <div className="p-8 rounded-2xl border bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <div className="text-center mb-8">
              ...
              />
              <h3 className="text-2xl font-bold text-black dark:text-white">{user.displayName}</h3>
              <p className="font-semibold text-lg text-gray-600 dark:text-gray-300">@{user.username}</p>
              {user.email && (
            ...
            <div className="space-y-4">
              <button 
                ...
                className="w-full flex justify-between items-center p-4 rounded-lg border hover:shadow-lg transition-all duration-300 bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600"
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-lg font-semibold text-black dark:text-white">GitHub</span>
                </div>
              ...
              >
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-gray-600 dark:bg-gray-400 text-white dark:text-gray-900 rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                  </div>
                  <span className="text-lg font-semibold text-black dark:text-white">My Repositories</span>
                </div>
                <div className="px-3 py-1 bg-gray-600 dark:bg-gray-400 text-white dark:text-gray-900 text-sm rounded-full font-medium">
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-lg font-semibold text-black dark:text-white">My Issues</span>
                </div>
              ...
              <button 
                ...
                className="w-full flex justify-between items-center p-4 rounded-lg border hover:shadow-lg transition-all duration-300 disabled:opacity-50 bg-gray-50 dark:bg-gray-700 border-gray-200 dark:border-gray-600"
              >
                <div className="flex items-center space-x-4">
                  <div className="w-10 h-10 bg-gray-600 dark:bg-gray-400 text-white dark:text-gray-900 rounded-lg flex items-center justify-center">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-lg font-semibold text-black dark:text-white">Followers</span>
                </div>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="text-lg font-semibold text-black dark:text-white">Following</span>
                </div>
          ...
          {/* Quick Actions */}
          <div className="p-8 rounded-2xl border bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <h3 className="text-2xl font-bold mb-8 text-center text-black dark:text-white">Quick Actions</h3>
            <div className="space-y-4">
              <button 
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-bold text-black dark:text-white">Create New Repository</div>
                    <div className="text-gray-600 dark:text-gray-300 text-sm">Start a new project on GitHub</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-bold text-black dark:text-white">GitHub Copilot</div>
                    <div className="text-gray-600 dark:text-gray-300 text-sm">AI-powered code completion</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-bold text-black dark:text-white">GitHub Student Pack</div>
                    <div className="text-gray-600 dark:text-gray-300 text-sm">Free developer tools worth $200k+</div>
                  </div>
                </div>
              </button>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-bold text-black dark:text-white">GitHub Codespaces</div>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-bold text-black dark:text-white">Explore</div>
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <div className="font-bold text-themed-primary">Delete Repository</div>
                    <div className="text-themed-secondary text-sm">Permanently delete a repository</div>
                  </div>
                </div>
              </button>
            </div>
          ...
          {/* Recent Activity */}
          <div className="p-8 rounded-2xl border bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
            <h3 className="text-2xl font-bold mb-8 text-center text-black dark:text-white">Recent Activity</h3>
            <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-96 overflow-hidden">
              <div className="p-6 border-b border-gray-200 dark:border-gray-600">
                <div className="flex justify-between items-center">
                  <h3 className="text-xl font-bold text-black dark:text-white">Followers</h3>
                  <button 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {followers.map((follower, index) => (
                      <div key={index} className="flex items-center space-x-3 p-3 bg-white dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                        ...
                        />
                        <div className="flex-1">
                          <p className="font-semibold text-black dark:text-white">{follower.username}</p>
        ...
        {showFollowing && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-96 overflow-hidden">
              <div className="p-6 border-b border-gray-200 dark:border-gray-600">
                <div className="flex justify-between items-center">
                  <h3 className="text-xl font-bold text-black dark:text-white">Following</h3>
                  <button 
        ...
        {showDeleteRepo && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-themed-secondary rounded-lg shadow-xl max-w-md w-full">
              <div className="p-6 border-b border-themed">
                <div className="flex justify-between items-center">
                  <h3 className="text-xl font-bold text-themed-primary">Delete Repository</h3>
                  <button 
                    onClick={() => setShowDeleteRepo(false)}
                    className="text-themed-tertiary hover:text-themed-primary"
                  >
                    ✕
                  </button>
                </div>
              ...
              <div className="p-6">
                <div className="mb-4">
                  <label className="block text-themed-primary font-semibold mb-2">
                  ...
                  <input
                    ...
                    className="w-full p-3 border border-themed rounded-lg bg-themed-primary text-themed-primary"
                  />
                </div>
                <div className="bg-red-50 border-2 border-red-200 rounded-lg p-4 mb-4">
                  <p className="text-red-800 font-semibold">⚠️ Warning</p>
                  <p className="text-red-600 text-sm">This action cannot be undone. This will permanently delete the repository and all its contents.</p>
                </div>
                <div className="flex space-x-3">
                  ...
                  <button
                    onClick={() => setShowDeleteRepo(false)}
                    className="flex-1 bg-themed-tertiary text-themed-primary px-4 py-2 rounded-lg hover:bg-themed-secondary transition-colors"
                  >
                    Cancel
                  </button>
                </div>
